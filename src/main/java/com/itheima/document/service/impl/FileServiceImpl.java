...
import com.itheima.document.dao.FileDao;
...
public class FileServiceImpl implements FileService {
     ...
     */
    @Override
    public List<File> queryAllByLimit(int offset, int limit,String operator) {
        return this.fileDao.queryAllByLimit(offset, limit, operator);
    }
